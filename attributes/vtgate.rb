...
default['vinted-vitess']['vtgate']['allowed']['tablet']['types'] = nil

# log to standard error as well as files
default['vinted-vitess']['vtgate']['alsologtostderr'] = nil
...
default['vinted-vitess']['vtgate']['buffer']['keyspace']['shards'] = nil
...
default['vinted-vitess']['vtgate']['cells']['to']['watch'] = nil
...
default['vinted-vitess']['vtgate']['emit']['stats'] = nil

# Detect and log failover events, but do not actually buffer requests.
default['vinted-vitess']['vtgate']['enable']['buffer']['dry']['run'] = nil

# Enable buffering (stalling) of master traffic during failovers.
default['vinted-vitess']['vtgate']['enable']['buffer'] = nil
...
default['vinted-vitess']['vtgate']['enable']['forwarding'] = nil
...
default['vinted-vitess']['vtgate']['grpc']['auth']['mode'] = nil

# string when using grpc_static_auth in the server, this file provides the credentials to use to authenticate with server
default['vinted-vitess']['vtgate']['grpc']['auth']['static']['client']['creds'] = nil

# string JSON File to read the users/passwords from.
default['vinted-vitess']['vtgate']['grpc']['auth']['static']['password']['file'] = nil

# string ca to use, requires TLS, and enforces client cert check
default['vinted-vitess']['vtgate']['grpc']['ca'] = nil

# string certificate to use, requires grpc_key, enables TLS
default['vinted-vitess']['vtgate']['grpc']['cert'] = nil

# string how to compress gRPC, default: nothing, supported: snappy
default['vinted-vitess']['vtgate']['grpc']['compression'] = nil

# Enable GRPC tracing
default['vinted-vitess']['vtgate']['grpc']['enable']['tracing'] = nil

# int grpc initial connection window size
default['vinted-vitess']['vtgate']['grpc']['initial']['conn']['window']['size'] = nil

# int grpc initial window size
default['vinted-vitess']['vtgate']['grpc']['initial']['window']['size'] = nil
...
default['vinted-vitess']['vtgate']['grpc']['keepalive']['time'] = nil
...
default['vinted-vitess']['vtgate']['grpc']['keepalive']['timeout'] = nil

# string key to use, requires grpc_cert, enables TLS
default['vinted-vitess']['vtgate']['grpc']['key'] = nil
...
default['vinted-vitess']['vtgate']['grpc']['port'] = nil

# Enable gRPC monitoring with Prometheus
default['vinted-vitess']['vtgate']['grpc']['prometheus'] = nil

# int grpc server initial connection window size
default['vinted-vitess']['vtgate']['grpc']['server']['initial']['conn']['window']['size'] = nil

# int grpc server initial window size
default['vinted-vitess']['vtgate']['grpc']['server']['initial']['window']['size'] = nil
...
default['vinted-vitess']['vtgate']['grpc']['use']['effective']['callerid'] = nil
...
default['vinted-vitess']['vtgate']['keep']['logs'] = nil
...
default['vinted-vitess']['vtgate']['l2vtgate']['addrs'] = nil
...
default['vinted-vitess']['vtgate']['log']['backtrace']['at'] = nil

# string If non-empty, write log files in this directory
default['vinted-vitess']['vtgate']['log']['dir'] = nil

# string Enable query logging to the specified file
default['vinted-vitess']['vtgate']['log']['queries']['to']['file'] = nil

# log to standard error instead of files
default['vinted-vitess']['vtgate']['logtostderr'] = nil
...
default['vinted-vitess']['vtgate']['mutex']['profile']['fraction'] = nil

# If set, the server will allow the use of a clear text password over non-SSL connections.
default['vinted-vitess']['vtgate']['mysql']['allow']['clear']['text']['without']['tls'] = nil

# string Which auth server implementation to use. (default "static")
default['vinted-vitess']['vtgate']['mysql']['auth']['server']['impl'] = 'static'

# string JSON File to read the users/passwords from.
default['vinted-vitess']['vtgate']['mysql']['auth']['server']['static']['file'] = nil

# string JSON representation of the users/passwords config.
default['vinted-vitess']['vtgate']['mysql']['auth']['server']['static']['string'] = nil

# string JSON File from which to read LDAP server config.
default['vinted-vitess']['vtgate']['mysql']['ldap']['auth']['config']['file'] = nil

# string JSON representation of LDAP server config.
default['vinted-vitess']['vtgate']['mysql']['ldap']['auth']['config']['string'] = nil
...
default['vinted-vitess']['vtgate']['mysql']['server']['bind']['address'] = nil
...
default['vinted-vitess']['vtgate']['mysql']['server']['query']['timeout'] = nil

# duration connection read timeout
default['vinted-vitess']['vtgate']['mysql']['server']['read']['timeout'] = nil

# Reject insecure connections but only if mysql_server_ssl_cert and mysql_server_ssl_key are provided
default['vinted-vitess']['vtgate']['mysql']['server']['require']['secure']['transport'] = nil
...
default['vinted-vitess']['vtgate']['mysql']['server']['socket']['path'] = nil

# string Path to ssl CA for mysql server plugin SSL. If specified, server will require and validate client certs.
default['vinted-vitess']['vtgate']['mysql']['server']['ssl']['ca'] = nil

# string Path to the ssl cert for mysql server plugin SSL
default['vinted-vitess']['vtgate']['mysql']['server']['ssl']['cert'] = nil

# string Path to ssl key for mysql server plugin SSL
default['vinted-vitess']['vtgate']['mysql']['server']['ssl']['key'] = nil
...
default['vinted-vitess']['vtgate']['mysql']['server']['write']['timeout'] = nil

# duration Warn if it takes more than the given threshold for a mysql connection to establish
default['vinted-vitess']['vtgate']['mysql']['slow']['connect']['warn']['threshold'] = nil
...
default['vinted-vitess']['vtgate']['opentsdb']['uri'] = nil

# string If set, the process will write its pid to the named file, and delete it on graceful shutdown.
default['vinted-vitess']['vtgate']['pid']['file'] = nil

# int port for the server
default['vinted-vitess']['vtgate']['port'] = nil
...
default['vinted-vitess']['vtgate']['tablet']['filters'] = nil

# string the server ca to use to validate servers when connecting
default['vinted-vitess']['vtgate']['tablet']['grpc']['ca'] = nil

# string the cert to use to connect
default['vinted-vitess']['vtgate']['tablet']['grpc']['cert'] = nil

# string the key to use to connect
default['vinted-vitess']['vtgate']['tablet']['grpc']['key'] = nil

# string the server name to use to validate server certificate
default['vinted-vitess']['vtgate']['tablet']['grpc']['server']['name'] = nil
...
default['vinted-vitess']['vtgate']['tablet']['types']['to']['wait'] = nil
...
default['vinted-vitess']['vtgate']['topo']['global']['root'] = nil

# string the address of the global topology server
default['vinted-vitess']['vtgate']['topo']['global']['server']['address'] = nil
...
default['vinted-vitess']['vtgate']['vmodule'] = nil

# string List of users authorized to execute vschema ddl operations, or '%' to allow all users.
default['vinted-vitess']['vtgate']['vschema']['ddl']['authorized']['users'] = nil

# string address of a vtctld instance
default['vinted-vitess']['vtgate']['vtctld']['addr'] = nil

# prevent bind vars from escaping in returned errors
default['vinted-vitess']['vtgate']['vtgate']['config']['terse']['errors'] = nil

# value log level for V logs
default['vinted-vitess']['vtgate']['v'] = nil
