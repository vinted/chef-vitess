...
# default['vinted-vitess']['vtctld']['alsologtostderr'] =
...
# default['vinted-vitess']['vtctld']['backup']['storage']['hook'] =

# string which implementation to use for the backup storage feature
# default['vinted-vitess']['vtctld']['backup']['storage']['implementation'] =
...
# string cell to use
# default['vinted-vitess']['vtctld']['cell'] =
...
# default['vinted-vitess']['vtctld']['consul']['auth']['static']['file'] =

# string write cpu profile to file
# default['vinted-vitess']['vtctld']['cpu']['profile'] =
...
# default['vinted-vitess']['vtctld']['db']['credentials']['file'] =
...
# default['vinted-vitess']['vtctld']['disable']['active']['reparents'] =
...
# default['vinted-vitess']['vtctld']['grpc']['keepalive']['time'] =
...
# default['vinted-vitess']['vtctld']['grpc']['keepalive']['timeout'] =

# string key to use, requires grpc_cert, enables TLS
# default['vinted-vitess']['vtctld']['grpc']['key'] =
...
# default['vinted-vitess']['vtctld']['grpc']['port'] =

# Enable gRPC monitoring with Prometheus
# default['vinted-vitess']['vtctld']['grpc']['prometheus'] =

# int grpc server initial connection window size
# default['vinted-vitess']['vtctld']['grpc']['server']['initial']['conn']['window']['size'] =

# int grpc server initial window size
# default['vinted-vitess']['vtctld']['grpc']['server']['initial']['window']['size'] =
...
# default['vinted-vitess']['vtctld']['keep']['logs'] =
...
# default['vinted-vitess']['vtctld']['log']['backtrace']['at'] =

# string If non-empty, write log files in this directory
# default['vinted-vitess']['vtctld']['log']['dir'] =

# log to standard error instead of files
# default['vinted-vitess']['vtctld']['logtostderr'] =
...
# default['vinted-vitess']['vtctld']['mutex']['profile']['fraction'] =

# string JSON File to read the users/passwords from.
# default['vinted-vitess']['vtctld']['mysql']['auth']['server']['static']['file'] =

# string JSON representation of the users/passwords config.
# default['vinted-vitess']['vtctld']['mysql']['auth']['server']['static']['string'] =
...
# default['vinted-vitess']['vtctld']['mysqlctl']['mycnf']['template'] =

# string socket file to use for remote mysqlctl actions (empty for local actions)
# default['vinted-vitess']['vtctld']['mysqlctl']['socket'] =
...
# default['vinted-vitess']['vtctld']['s3']['backup']['aws']['endpoint'] =
...
# default['vinted-vitess']['vtctld']['s3']['backup']['force']['path']['style'] =
...
# default['vinted-vitess']['vtctld']['s3']['backup']['server']['side']['encryption'] =

# string S3 bucket to use for backups
# default['vinted-vitess']['vtctld']['s3']['backup']['storage']['bucket'] =

# string root prefix for all backup-related object names
# default['vinted-vitess']['vtctld']['s3']['backup']['storage']['root'] =

# skip the 'certificate is valid' check for SSL connections
# default['vinted-vitess']['vtctld']['s3']['backup']['tls']['skip']['verify']['cert'] =
...
# default['vinted-vitess']['vtctld']['schema']['change']['controller'] =
...
# default['vinted-vitess']['vtctld']['schema']['change']['dir'] =
...
# default['vinted-vitess']['vtctld']['schema']['change']['user'] =
...
# default['vinted-vitess']['vtctld']['tablet']['dir'] =

# string the server ca to use to validate servers when connecting
# default['vinted-vitess']['vtctld']['tablet']['grpc']['ca'] =

# string the cert to use to connect
# default['vinted-vitess']['vtctld']['tablet']['grpc']['cert'] =

# string the key to use to connect
# default['vinted-vitess']['vtctld']['tablet']['grpc']['key'] =

# string the server name to use to validate server certificate
# default['vinted-vitess']['vtctld']['tablet']['grpc']['server']['name'] =
...
# string the server ca to use to validate servers when connecting
# default['vinted-vitess']['vtctld']['tablet']['manager']['grpc']['ca'] =

# string the cert to use to connect
# default['vinted-vitess']['vtctld']['tablet']['manager']['grpc']['cert'] =
...
# string the key to use to connect
# default['vinted-vitess']['vtctld']['tablet']['manager']['grpc']['key'] =

# string the server name to use to validate server certificate
# default['vinted-vitess']['vtctld']['tablet']['manager']['grpc']['server']['name'] =
...
# string the server ca to use to validate servers when connecting
# default['vinted-vitess']['vtctld']['throttler']['client']['grpc']['ca'] =

# string the cert to use to connect
# default['vinted-vitess']['vtctld']['throttler']['client']['grpc']['cert'] =

# string the key to use to connect
# default['vinted-vitess']['vtctld']['throttler']['client']['grpc']['key'] =

# string the server name to use to validate server certificate
# default['vinted-vitess']['vtctld']['throttler']['client']['grpc']['server']['name'] =
...
# default['vinted-vitess']['vtctld']['topo']['global']['root'] =

# string the address of the global topology server
# default['vinted-vitess']['vtctld']['topo']['global']['server']['address'] =
...
# string the server ca to use to validate servers when connecting
# default['vinted-vitess']['vtctld']['vtgate']['grpc']['ca'] =

# string the cert to use to connect
# default['vinted-vitess']['vtctld']['vtgate']['grpc']['cert'] =

# string the key to use to connect
# default['vinted-vitess']['vtctld']['vtgate']['grpc']['key'] =

# string the server name to use to validate server certificate
# default['vinted-vitess']['vtctld']['vtgate']['grpc']['server']['name'] =

# string how to talk to vtgate (default "grpc")
default['vinted-vitess']['vtctld']['vtgate']['protocol'] = 'grpc'

# string the server ca to use to validate servers when connecting
# default['vinted-vitess']['vtctld']['vtworker']['client']['grpc']['ca'] =

# string the cert to use to connect
# default['vinted-vitess']['vtctld']['vtworker']['client']['grpc']['cert'] =

# string the key to use to connect
# default['vinted-vitess']['vtctld']['vtworker']['client']['grpc']['key'] =

# string the server name to use to validate server certificate
# default['vinted-vitess']['vtctld']['vtworker']['client']['grpc']['server']['name'] =
...
# default['vinted-vitess']['vtctld']['v'] =
