...
default['vitess']['vtctld']['backup']['storage']['block']['size'] = 250000
...
default['vitess']['vtctld']['backup']['storage']['compress'] = true

# string if set, we send the contents of the backup files through this hook.
default['vitess']['vtctld']['backup']['storage']['hook'] = nil

# string which implementation to use for the backup storage feature
default['vitess']['vtctld']['backup']['storage']['implementation'] = nil
...
default['vitess']['vtctld']['disable']['active']['reparents'] = nil
...
default['vitess']['vtctld']['grpc']['keepalive']['time'] = nil
...
default['vitess']['vtctld']['grpc']['keepalive']['timeout'] = nil

# string key to use, requires grpc_cert, enables TLS
default['vitess']['vtctld']['grpc']['key'] = nil

# duration Maximum age of a client connection before GoAway is sent. (default 2562047h47m16.854775807s)
default['vitess']['vtctld']['grpc']['max']['connection']['age'] = '2562047h47m16.854775807s'
...
default['vitess']['vtctld']['grpc']['max']['connection']['age']['grace'] = '2562047h47m16.854775807s'
...
default['vitess']['vtctld']['grpc']['max']['message']['size'] = 16777216

# int Port to listen on for gRPC calls
default['vitess']['vtctld']['grpc']['port'] = nil

# Enable gRPC monitoring with Prometheus
default['vitess']['vtctld']['grpc']['prometheus'] = nil

# int grpc server initial connection window size
default['vitess']['vtctld']['grpc']['server']['initial']['conn']['window']['size'] = nil

# int grpc server initial window size
default['vitess']['vtctld']['grpc']['server']['initial']['window']['size'] = nil

# duration grpc server minimum keepalive time (default 5m0s)
default['vitess']['vtctld']['grpc']['server']['keepalive']['enforcement']['policy']['min']['time'] = '5m0s'

# string the name of the influxdb database (default "vitess")
default['vitess']['vtctld']['influxdb']['database'] = 'vitess'

# string the influxdb host (with port) (default "localhost:8086")
default['vitess']['vtctld']['influxdb']['host'] = 'localhost:8086'

# string influxdb password (default "root")
default['vitess']['vtctld']['influxdb']['password'] = 'root'

# string influxdb username (default "root")
default['vitess']['vtctld']['influxdb']['username'] = 'root'

# duration keep logs for this long (zero to keep forever)
default['vitess']['vtctld']['keep']['logs'] = nil
...
default['vitess']['vtctld']['lock']['timeout'] = '30s'

# value when logging hits line file:N, emit a stack trace
default['vitess']['vtctld']['log']['backtrace']['at'] = nil

# string If non-empty, write log files in this directory
default['vitess']['vtctld']['log']['dir'] = nil
...
default['vitess']['vtctld']['master']['connect']['retry'] = '10s'
...
default['vitess']['vtctld']['min']['number']['serving']['vttablets'] = 2
...
default['vitess']['vtctld']['s3']['backup']['log']['level'] = 'LogOff'

# string server-side encryption algorithm (e.g., AES256, aws:kms)
default['vitess']['vtctld']['s3']['backup']['server']['side']['encryption'] = nil

# string S3 bucket to use for backups
default['vitess']['vtctld']['s3']['backup']['storage']['bucket'] = nil

# string root prefix for all backup-related object names
default['vitess']['vtctld']['s3']['backup']['storage']['root'] = nil

# skip the 'certificate is valid' check for SSL connections
default['vitess']['vtctld']['s3']['backup']['tls']['skip']['verify']['cert'] = nil

# int this value decides how often we check schema change dir, in seconds (default 60)
default['vitess']['vtctld']['schema']['change']['check']['interval'] = 60

# string schema change controller is responsible for finding schema changes and responsing schema change events
default['vitess']['vtctld']['schema']['change']['controller'] = nil
...
default['vitess']['vtctld']['tablet']['dir'] = nil

# string the server ca to use to validate servers when connecting
default['vitess']['vtctld']['tablet']['grpc']['ca'] = nil

# string the cert to use to connect
default['vitess']['vtctld']['tablet']['grpc']['cert'] = nil

# string the key to use to connect
default['vitess']['vtctld']['tablet']['grpc']['key'] = nil

# string the server name to use to validate server certificate
default['vitess']['vtctld']['tablet']['grpc']['server']['name'] = nil

# duration close streaming tablet health connection if there are no requests for this long (default 5m0s)
default['vitess']['vtctld']['tablet']['health']['keep']['alive'] = '5m0s'

# string the server ca to use to validate servers when connecting
default['vitess']['vtctld']['tablet']['manager']['grpc']['ca'] = nil

# string the cert to use to connect
default['vitess']['vtctld']['tablet']['manager']['grpc']['cert'] = nil
...
default['vitess']['vtctld']['tablet']['manager']['grpc']['concurrency'] = 8

# string the key to use to connect
default['vitess']['vtctld']['tablet']['manager']['grpc']['key'] = nil

# string the server name to use to validate server certificate
default['vitess']['vtctld']['tablet']['manager']['grpc']['server']['name'] = nil

# string the protocol to use to talk to vttablet (default "grpc")
default['vitess']['vtctld']['tablet']['manager']['protocol'] = 'grpc'

# string how to talk to the vttablets (default "grpc")
default['vitess']['vtctld']['tablet']['protocol'] = 'grpc'
...
default['vitess']['vtctld']['vtctl']['client']['protocol'] = 'grpc'

# Controls the display of the CRUD topology actions in the vtctld UI. (default true)
default['vitess']['vtctld']['vtctld']['show']['topology']['crud'] = true

# duration delay before retrying a failed healthcheck (default 5s)
default['vitess']['vtctld']['vtctl']['healthcheck']['retry']['delay'] = '5s'

# duration the health check timeout period (default 1m0s)
default['vitess']['vtctld']['vtctl']['healthcheck']['timeout'] = '1m0s'

# duration refresh interval for re-reading the topology (default 30s)
default['vitess']['vtctld']['vtctl']['healthcheck']['topology']['refresh'] = '30s'

# string the server ca to use to validate servers when connecting
default['vitess']['vtctld']['vtgate']['grpc']['ca'] = nil

# string the cert to use to connect
default['vitess']['vtctld']['vtgate']['grpc']['cert'] = nil

# string the key to use to connect
default['vitess']['vtctld']['vtgate']['grpc']['key'] = nil

# string the server name to use to validate server certificate
default['vitess']['vtctld']['vtgate']['grpc']['server']['name'] = nil

# string how to talk to vtgate (default "grpc")
default['vitess']['vtctld']['vtgate']['protocol'] = 'grpc'

# string the server ca to use to validate servers when connecting
default['vitess']['vtctld']['vtworker']['client']['grpc']['ca'] = nil

# string the cert to use to connect
default['vitess']['vtctld']['vtworker']['client']['grpc']['cert'] = nil

# string the key to use to connect
default['vitess']['vtctld']['vtworker']['client']['grpc']['key'] = nil

# string the server name to use to validate server certificate
default['vitess']['vtctld']['vtworker']['client']['grpc']['server']['name'] = nil

# string the protocol to use to talk to the vtworker server (default "grpc")
default['vitess']['vtctld']['vtworker']['client']['protocol'] = 'grpc'
