...
default['vitess']['vtgate']['allowed']['tablet']['types'] = nil
...
default['vitess']['vtgate']['buffer']['drain']['concurrency'] = 1
...
default['vitess']['vtgate']['buffer']['keyspace']['shards'] = nil

# duration Stop buffering completely if a failover takes longer than this duration. (default 20s)
default['vitess']['vtgate']['buffer']['max']['failover']['duration'] = '20s'
...
default['vitess']['vtgate']['enable']['forwarding'] = nil
...
default['vitess']['vtgate']['gate']['query']['cache']['size'] = 10000

# string The implementation of gateway (default "discoverygateway")
default['vitess']['vtgate']['gateway']['implementation'] = 'discoverygateway'
...
default['vitess']['vtgate']['gateway']['initial']['tablet']['timeout'] = '30s'

# string Which auth plugin implementation to use (eg: static)
default['vitess']['vtgate']['grpc']['auth']['mode'] = nil

# string when using grpc_static_auth in the server, this file provides the credentials to use to authenticate with server
default['vitess']['vtgate']['grpc']['auth']['static']['client']['creds'] = nil

# string JSON File to read the users/passwords from.
default['vitess']['vtgate']['grpc']['auth']['static']['password']['file'] = nil

# string ca to use, requires TLS, and enforces client cert check
default['vitess']['vtgate']['grpc']['ca'] = nil

# string certificate to use, requires grpc_key, enables TLS
default['vitess']['vtgate']['grpc']['cert'] = nil

# string how to compress gRPC, default: nothing, supported: snappy
default['vitess']['vtgate']['grpc']['compression'] = nil

# Enable GRPC tracing
default['vitess']['vtgate']['grpc']['enable']['tracing'] = nil

# int grpc initial connection window size
default['vitess']['vtgate']['grpc']['initial']['conn']['window']['size'] = nil

# int grpc initial window size
default['vitess']['vtgate']['grpc']['initial']['window']['size'] = nil
...
default['vitess']['vtgate']['grpc']['keepalive']['time'] = nil
...
default['vitess']['vtgate']['grpc']['keepalive']['timeout'] = nil

# string key to use, requires grpc_cert, enables TLS
default['vitess']['vtgate']['grpc']['key'] = nil

# duration Maximum age of a client connection before GoAway is sent. (default 2562047h47m16.854775807s)
default['vitess']['vtgate']['grpc']['max']['connection']['age'] = '2562047h47m16.854775807s'
...
default['vitess']['vtgate']['grpc']['max']['connection']['age']['grace'] = '2562047h47m16.854775807s'
...
default['vitess']['vtgate']['grpc']['max']['message']['size'] = 16777216

# int Port to listen on for gRPC calls
default['vitess']['vtgate']['grpc']['port'] = nil

# Enable gRPC monitoring with Prometheus
default['vitess']['vtgate']['grpc']['prometheus'] = nil

# int grpc server initial connection window size
default['vitess']['vtgate']['grpc']['server']['initial']['conn']['window']['size'] = nil

# int grpc server initial window size
default['vitess']['vtgate']['grpc']['server']['initial']['window']['size'] = nil

# duration grpc server minimum keepalive time (default 5m0s)
default['vitess']['vtgate']['grpc']['server']['keepalive']['enforcement']['policy']['min']['time'] = '5m0s'

# If set, and SSL is not used, will set the immediate caller id from the effective caller id's principal.
default['vitess']['vtgate']['grpc']['use']['effective']['callerid'] = nil

# duration health check retry delay (default 2ms)
default['vitess']['vtgate']['healthcheck']['retry']['delay'] = '2ms'

# duration the health check timeout period (default 1m0s)
default['vitess']['vtgate']['healthcheck']['timeout'] = '1m0s'

# string the name of the influxdb database (default "vitess")
default['vitess']['vtgate']['influxdb']['database'] = 'vitess'

# string the influxdb host (with port) (default "localhost:8086")
default['vitess']['vtgate']['influxdb']['host'] = 'localhost:8086'

# string influxdb password (default "root")
default['vitess']['vtgate']['influxdb']['password'] = 'root'

# string influxdb username (default "root")
default['vitess']['vtgate']['influxdb']['username'] = 'root'

# duration keep logs for this long (zero to keep forever)
default['vitess']['vtgate']['keep']['logs'] = nil
...
default['vitess']['vtgate']['l2vtgate']['addrs'] = nil
...
default['vitess']['vtgate']['lock']['timeout'] = '30s'

# value when logging hits line file:N, emit a stack trace
default['vitess']['vtgate']['log']['backtrace']['at'] = nil

# string If non-empty, write log files in this directory
default['vitess']['vtgate']['log']['dir'] = nil

# string Enable query logging to the specified file
default['vitess']['vtgate']['log']['queries']['to']['file'] = nil
...
default['vitess']['vtgate']['mysql']['allow']['clear']['text']['without']['tls'] = nil

# string Which auth server implementation to use. (default "static")
default['vitess']['vtgate']['mysql']['auth']['server']['impl'] = 'static'

# string JSON File to read the users/passwords from.
default['vitess']['vtgate']['mysql']['auth']['server']['static']['file'] = nil

# string JSON representation of the users/passwords config.
default['vitess']['vtgate']['mysql']['auth']['server']['static']['string'] = nil

# string JSON File from which to read LDAP server config.
default['vitess']['vtgate']['mysql']['ldap']['auth']['config']['file'] = nil

# string JSON representation of LDAP server config.
default['vitess']['vtgate']['mysql']['ldap']['auth']['config']['string'] = nil
...
default['vitess']['vtgate']['mysql']['ldap']['auth']['method'] = 'mysql_clear_password'
...
default['vitess']['vtgate']['mysql']['server']['bind']['address'] = nil

# int If set, also listen for MySQL binary protocol connections on this port. (default -1)
default['vitess']['vtgate']['mysql']['server']['port'] = -1

# duration mysql query timeout
default['vitess']['vtgate']['mysql']['server']['query']['timeout'] = nil

# duration connection read timeout
default['vitess']['vtgate']['mysql']['server']['read']['timeout'] = nil

# Reject insecure connections but only if mysql_server_ssl_cert and mysql_server_ssl_key are provided
default['vitess']['vtgate']['mysql']['server']['require']['secure']['transport'] = nil
...
default['vitess']['vtgate']['transaction']['mode'] = 'MULTI'
...
default['vitess']['vtgate']['vschema']['ddl']['authorized']['users'] = nil

# string address of a vtctld instance
default['vitess']['vtgate']['vtctld']['addr'] = nil
